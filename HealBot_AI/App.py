...
def get_medical_advice():
    ...
    try:
        ...
        (Age: {user_data.get('age', 'unknown')}, Gender: {user_data.get('gender', 'unknown')}), Alergies : {user_data.get('alergies', 'unknown')}, Medical history : {user_data.get('medical_history', 'unknown')}
